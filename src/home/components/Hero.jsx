  ...
  return (
    <div className='hero'>
      ...
      <div className='video'>
       ...
       {secret1? <iframe width="100%" height="500px" src="https://www.youtube.com/embed/fZUCxE3hsME?autoplay=1" title="YouTube video player" frameBorder="0" allow="autoplay" allowFullScreen></iframe> : <video src={video} width="100%" autoPlay loop ></video>}
